...
| `Subject`               | `dc:subject`; `lr:hierarchicalSubject`; `Iptc4xmpExt:PersonInImage`            | `Subject`, `HierarchicalSubject`, `PersonInImage`, `CatalogSets`, `ObjectName`        | ✓                   | —                                                                            |
| `Keywords`              | `dc:subject` (aggregated)                                                        | `Keywords`                                                                            | ✓                   | ✓ `dc:subject/rdf:Bag` → `dc:subject/rdf:Seq`                                |
