...
### Make your changes ###
  ...
  * We recommend running [[tests]] after each change to make sure you didn't break anything:
    * `make test`
  * **Add [[tests]] for any new code.** If you have questions about how to do this, please ask in your pull request or on our [mailing list](https://groups.google.com/a/photoprism.org/forum/#!forum/developers).
...
### When you’re ready... ###
  ...
  * Write [[documentation]] if you are adding new features or changing functionality. It is hosted on [docs.photoprism.org](https://docs.photoprism.org/en/latest/) and automatically updates whenever changes are pushed to the repository.
