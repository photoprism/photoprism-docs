...
| PHOTOPRISM_FACE_SIZE_RETRY       | --face-size-retry       | *(from the thumbnails)*       | Minimum face size in `PIXELS` for the second detection pass, used only when a picture would have none.         |
