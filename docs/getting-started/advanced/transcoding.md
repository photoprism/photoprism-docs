...
Since FFmpeg 7 has significant [performance optimizations](https://www.debugpoint.com/ffmpeg-7-0-features/) compared to version 6.1.1 that ships with Ubuntu 24.04, users of our Docker image can choose to install the latest FFmpeg 7 build available at [johnvansickle.com/ffmpeg/](https://johnvansickle.com/ffmpeg/). To do this, add `PHOTOPRISM_INIT: "ffmpeg"` to the environment section of your `compose.yaml` or `docker-compose.yml` file:
