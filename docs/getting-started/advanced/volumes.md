...
You may [mount any folder accessible from the host](https://docs.docker.com/compose/compose-file/compose-file-v3/#short-syntax-3) instead, including network drives (see below). Additional directories can be mounted as subfolders of `/photoprism/originals`:
