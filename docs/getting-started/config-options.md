...
| PHOTOPRISM_UPLOAD_NSFW      | --upload-nsfw      |                              | allows uploads that might be offensive (web upload rejects detected files when this is `false`; see [Using AI Models](../user-guide/ai/index.md#nsfw-detection)) |
...
| PHOTOPRISM_DETECT_NSFW     | --detect-nsfw     |             | flags newly added pictures as private if they might be offensive (see [Using AI Models](../user-guide/ai/index.md#nsfw-detection) for the model/flag interactions) |
