...
This is possible if you run it [behind a reverse proxy](proxies/traefik.md), though *experimental and not extensively tested*. Depending on [the resources available to us](https://photoprism.app/membership), we [work to resolve known issues](https://link.photoprism.app/roadmap) over time.

To give specific examples: (a) For our [Progressive Web App (PWA)](../user-guide/pwa.md) to work as intended, [the service worker](https://web.dev/learn/pwa/service-workers/) should be installed in the root directory. (b) Due to the way Web browsers function, sharing a domain with other services [can affect the performance](https://docs.pushtechnology.com/cloud/latest/manual/html/designguide/solution/support/connection_limitations.html) and [security](https://developer.mozilla.org/en-US/docs/Web/Security/Same-origin_policy) of all the apps installed. (c) The length of [sharing and other links](../user-guide/share/index.md) increases and may not match the documentation. (d) There may be problems with WebDAV sharing and [automatic indexing/importing](https://github.com/photoprism/photoprism/discussions/2386).
