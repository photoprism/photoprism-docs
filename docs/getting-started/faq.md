...
PhotoPrism therefore assumes that their image information is immutable. Other metadata changes are detected and
reflected in the index as usual when scanning your library. We recommend manually updating JPEG sidecar files or
adding new JPEGs as needed.
