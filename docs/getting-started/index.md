...
Our backend is currently compatible with [SQLite 3](https://www.sqlite.org/) and [MariaDB](https://mariadb.org/) 10.5.12+.[^2] Keep in mind that [SQLite is generally not a good choice](troubleshooting/sqlite.md) for users who demand scalability and high performance. Support for [MySQL 8 has been discontinued](https://github.com/photoprism/photoprism/issues/1764) due to low demand and missing features.[^3]
