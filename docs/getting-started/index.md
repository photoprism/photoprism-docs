...
We recommend running PhotoPrism with [Docker Compose](docker-compose.md) when hosting it on a private server. It is available for [Mac](https://docs.docker.com/desktop/setup/install/mac-install/), [Linux](troubleshooting/docker.md#installation), and [Windows](https://docs.docker.com/desktop/setup/install/windows-install/).
...
PhotoPrism requires a current, full-featured browser. We build and test against browser versions released within roughly the last two years, which as of September 2026 means [Chrome](https://www.google.com/chrome/)/[Chromium](https://www.chromium.org/getting-involved/download-chromium) 131+, [Edge](https://www.microsoft.com/en-us/edge) 149+, [Firefox](https://www.mozilla.org/en-US/firefox/all/#product-desktop-release) 152+, and [Safari/iOS](https://www.apple.com/safari/) 18.5+. Because that window moves with each release, treat these numbers as a snapshot rather than a fixed floor, and keep your browser up to date. If you see a warning on the splash screen prompting you to update your browser, please install the latest version or switch to one of these browsers before continuing.

Keep hardware acceleration and WebGL enabled to ensure optimal performance; [video playback](https://caniuse.com/?search=video%20format) and [interactive world maps](https://demo.photoprism.app/library/places) in [Places](../user-guide/organize/places.md) depend on them. Maps specifically require [WebGL 2](../known-issues.md#maps-require-webgl-2).[^4] Chrome, Safari, and Edge natively support [AAC](https://caniuse.com/aac "Advanced Audio Coding"), the default audio codec for [MPEG-4 AVC](https://caniuse.com/avc "Advanced Video Coding"), while Firefox and Opera only optionally support it.
...
[^4]: [WebGL 2](https://caniuse.com/webgl2) may not be fully supported by some versions of Firefox, especially on [Android](https://play.google.com/store/apps/details?id=org.mozilla.firefox&hl=en&pli=1). The 360° [panorama viewer](../user-guide/organize/panoramas.md) requires it as well.
