...
!!! tldr ""
    Never store database files, e.g. used by MariaDB or SQLite, on an unreliable device such as a USB stick, SD card or network drive, as this may lead to data loss and poor performance.
