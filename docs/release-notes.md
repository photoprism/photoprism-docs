...
- Faces: [Viewer sidebar allows to manually tag faces on pictures](https://github.com/photoprism/photoprism/issues/1548)
- Faces: [Dropped legacy Pigo detector in favor of ONNX-based detection](https://github.com/photoprism/photoprism/issues/5508)
- Upload: [Added a drag-and-drop zone for selecting files in the upload dialog](https://github.com/photoprism/photoprism/issues/1216)
...
- Videos: [Tagged HEVC remux output as `hvc1` and unified MP4 chunk scans](https://github.com/photoprism/photoprism/issues/5593)
...
- Frontend: [Improved form input validation and numeric range caps](https://github.com/photoprism/photoprism/issues/5584)
