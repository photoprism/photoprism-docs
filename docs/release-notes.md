...
- Metadata: [Exif IFD1 tags with existing IFD0 values are ignored](https://github.com/photoprism/photoprism/issues/2231)
- Metadata: [Brute-force search is skipped if no Exif headers were found in standard file formats](https://github.com/photoprism/photoprism/issues/2196)
