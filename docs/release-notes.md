...
### Development Preview
<span class="build">Build 260522-deb42b0e2</span>
...
- UX: [Improved frontend form validation and numeric range caps](https://github.com/photoprism/photoprism/issues/5584)
- Auth: [Enhanced login page with "Stay signed in on this device" toggle](https://github.com/photoprism/photoprism/issues/5476)
- Auth: [OIDC provider initialization is retried after transient discovery failure](https://github.com/photoprism/photoprism/issues/5478)
- Auth: [Fixed OIDC redirect of unauthenticated users when opening direct links](https://github.com/photoprism/photoprism/issues/5506)
- Viewer: [Enhanced sidebar with editable metadata, albums, and labels](https://github.com/photoprism/photoprism/issues/4966)
- Viewer: [Added a keyboard shortcut and menu action that toggles captions](https://github.com/photoprism/photoprism/issues/5580)
- People: [Viewer sidebar allows to manually tag faces on pictures](https://github.com/photoprism/photoprism/issues/1548)
- Faces: [Dropped legacy Pigo detector in favor of ONNX-based detection](https://github.com/photoprism/photoprism/issues/5508)
- Faces: [Added a `faces config` subcommand to list face-related options](https://github.com/photoprism/photoprism/issues/5597)
...
- Albums: [Fixed child paths overwriting parent folder albums](https://github.com/photoprism/photoprism/issues/5366)
- Thumbs: [Added native HEIC/AVIF reader and upgraded `libheif` from v1.21.2](https://github.com/photoprism/photoprism/issues/5509)
...
- Video: [Added support for Vulkan hardware transcoding using FFmpeg 8](https://github.com/photoprism/photoprism/issues/5592)
...
- Server: [Added support for `zstd` HTTP response compression](https://github.com/photoprism/photoprism/issues/5550)
- Server: [Pre-compressed frontend bundles for faster loading times](https://github.com/photoprism/photoprism/issues/5552)
