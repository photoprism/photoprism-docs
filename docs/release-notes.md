...
!!! note ""
    You can test [**upcoming features and enhancements**](https://link.photoprism.app/roadmap) by changing the image tag from `:latest` to `:preview`. Then [follow our update guide](getting-started/updates.md#docker-compose) to [pull the latest image](https://hub.docker.com/r/photoprism/photoprism/tags?page=1&name=preview) and restart your instance.
