...
### Development Preview ###
<span class="build">Build 230402-2f663fea6</span>
...
- Albums: [Improved error handling and validation of API parameter values](https://github.com/photoprism/photoprism/issues/3320)
