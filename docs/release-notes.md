...
This update includes additional usability and performance enhancements for the user interface, as well as a new thumbnail size for [Retina 5K displays](https://github.com/photoprism/photoprism/issues/4810), bridging the gap [between 4K and 8K resolution](https://docs.photoprism.app/user-guide/settings/advanced/#which-thumbnails-will-be-generated). We'd like to take this opportunity to thank [our community](https://floss.social/@photoprism), [contributors](https://docs.photoprism.app/developer-guide/) and [members](https://www.photoprism.app/editions#compare) whose support has been and continues to be essential to the success of the project! 🙏
