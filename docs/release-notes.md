...
### Development Preview
<span class="build">Build 260826-3cc014d1c</span>
...
- CLI: [Added `faces migrate` to switch a library to a new face model](user-guide/ai/face-recognition.md#cli-reference)
