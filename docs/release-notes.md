...
### Development Preview ###
<span class="build">Build 230723-2a002eca7</span>
...
- Metadata: [Added support for reading fstop favorite flag from XML sidecar files](https://github.com/photoprism/photoprism/pull/1873)
