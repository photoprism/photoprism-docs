...
- States: [Overview page sorts state albums by country](https://github.com/photoprism/photoprism/issues/1608)
- Folders: [Search on overview page also finds path names](https://github.com/photoprism/photoprism/issues/1737)
