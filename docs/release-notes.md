...
- JPEG XL: [Decodes images natively via libvips instead of the external "djxl" tool](https://github.com/photoprism/photoprism/issues/5693)
...
- Auth: [Adds a configurable OpenID Connect sign-in prompt to force re-authentication or account selection](https://github.com/photoprism/photoprism/issues/5698)
...
- Auth: [Sends a nonce so Cognito-issued ID tokens validate during OIDC sign-in](https://github.com/photoprism/photoprism/issues/5695)
- Auth: [Shows login, session, and OIDC errors in the current interface language](https://github.com/photoprism/photoprism/issues/5699)
...
- Metadata: [Maps the XMP `dc:subject` field to Subject instead of Keywords](https://github.com/photoprism/photoprism/issues/2075)
