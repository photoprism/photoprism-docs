...
- RAW: [Fell back to embedded JPEG previews for unsupported files](https://github.com/photoprism/photoprism/issues/5673)
- JPEG XL: [Decoded images natively via libvips instead of the external "djxl" tool](https://github.com/photoprism/photoprism/issues/5693)
...
- UX: [Showed notification messages in the current interface language](https://github.com/photoprism/photoprism/issues/5682)
...
- Auth: [Ended the upstream provider session on sign-out via OpenID Connect RP-initiated logout](https://github.com/photoprism/photoprism/issues/5684)
- Auth: [Sent a nonce so Cognito-issued ID tokens validate during OIDC sign-in](https://github.com/photoprism/photoprism/issues/5695)
- Auth: [Showed login, session, and OIDC errors in the current interface language](https://github.com/photoprism/photoprism/issues/5699)
...
- Places: [Stacked photos at the same location when zoomed in](https://github.com/photoprism/photoprism/issues/5643)
...
- Index: [Recorded original file names only for imported files](https://github.com/photoprism/photoprism/issues/5668)
...
- Metadata: [Mapped the XMP `dc:subject` field to Subject instead of Keywords](https://github.com/photoprism/photoprism/issues/2075)
...
- Setup: [Allowed the Helm chart to reference an external secret for the database password](https://github.com/photoprism/photoprism/issues/5661)
