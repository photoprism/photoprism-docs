...
!!! info ""
    Importing is automatically paused when free disk space falls below the [configured threshold](originals.md#free-storage-threshold), to prevent the *storage* volume from filling up completely.
