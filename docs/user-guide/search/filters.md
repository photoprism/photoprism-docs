...
| label       | string    | label:"cat\|dog&!blurry"              | Label names: \| is OR within a group, & is AND between groups (every positive group must match), leading ! negates a group (e.g. !rejected). Category expansion applies to both positive and negative terms. Escape a literal &, \|, or leading ! with \ |
...
| fisheye     | switch    | fisheye:yes                           | Finds fisheye 360° originals (e.g. Insta360 .insv/.insp)                                                                                                                                                                                                 |
